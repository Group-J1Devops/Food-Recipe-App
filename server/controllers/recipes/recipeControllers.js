...
exports.createRecipe = async (req, res) => {
  ...
  try {
    ...
    res
      .status(200)
      .json({ message: "Recipe created successfully!", recipeData });
  } catch (error) {
    console.log("error", error);
    res
      .status(500)
      .json({ errorMessage: "Unable to create recipe, try again", error });
  }
};
...
exports.updateRecipe = async (req, res) => {
  ...
  try {
    ...
    res
      .status(200)
      .json({ message: "Recipe updated successfully!", updateRecipe });
  } catch (error) {
    console.log("error", error);
    res
      .status(500)
      .json({ errorMessage: "Unable to update recipe, try again", error });
  }
};
...
exports.deleteRecipe = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ errorMessage: "Unable to delete recipe, try again", error });
  }
};
